...
function verity_scripts() {
	...
	// Load the html5 shiv.
	wp_enqueue_script( 'verity-html5', get_template_directory_uri() . '/assets/js/html5.min.js', array(), '3.7.3' );
	wp_script_add_data( 'verity-html5', 'conditional', 'lt IE 9' );

	wp_enqueue_script( 'verity-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.min.js', array(), '20151215', true );
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'verity-keyboard-image-navigation', get_template_directory_uri() . '/assets/js/keyboard-image-navigation.min.js', array( 'jquery' ), '20160816' );
	}
	...
	wp_enqueue_script( 'verity-script', get_template_directory_uri() . '/assets/js/functions.min.js', array( 'jquery', 'jquery-match-height' ), '20150507', true );
