...
final class verity_upgrade_pro_customize {
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'verity-upgrade-button-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/upgrade-button/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'verity-upgrade-button-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/upgrade-button/customize-controls.css' );
	}
}
